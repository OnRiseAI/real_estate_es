...
export default function LiveKitDemo({ businessName = "" }) {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-8 rounded-3xl border border-[#1A1A1F] bg-[#0E0E12]">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        {state === STATES.CONNECTING && (
          <button disabled className="w-full px-6 py-4 rounded-xl bg-[#1A1A1F] text-[#6B6B76] text-[15px] font-bold cursor-not-allowed">
            Connecting…
          </button>
        )}
        {state === STATES.ACTIVE && (
